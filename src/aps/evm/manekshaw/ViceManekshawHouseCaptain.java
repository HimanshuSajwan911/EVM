 ...
 * @author user
 */
public class ViceManekshawHouseCaptain extends javax.swing.JFrame {
String value,xxx,pri,vpri,tea,st,nota,vmctxt;;
    /**
     * Creates new form ThimayyaHouseCaptain1
     */
    public ViceManekshawHouseCaptain() {
        this.setUndecorated(true);
        initComponents();
    }
     public ViceManekshawHouseCaptain(String n) {
     this.setUndecorated(true);
        initComponents();
        value=n;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html> <body align=center>  Select  Your vice-manekshaw-house-captain  for <br>Session (2018-19)  </body>  </html>");

        jLabel7.setBackground(new java.awt.Color(0, 0, 0));
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/aps symbol/ashutosh.jpg"))); // NOI18N
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/aps symbol/sajandeep.jpg"))); // NOI18N
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        st="student";
          if(value.equals(pri)){
                ...
                xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+5 where ID=1 ";
                vmctxt=pri;
                ...
                xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+3 where ID=1 ";
                vmctxt=vpri;
          }
                ...
                xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+2 where ID=1";
                vmctxt=tea;
              
          }
          
          else if(value.equals(st)){
              xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+1 where ID=1 ";
              vmctxt=st;
          }  
        ...
        try{
           ...
           // String xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+1 where ID=1 ";
        ...
        st="student";
          if(value.equals(pri)){
                ...
                vmctxt=pri;
               RainaHouseCaptain mhc=new RainaHouseCaptain(vmctxt);
                mhc.setVisible(true);
                this.dispose();
          }
              ...
              vmctxt=st;
                 this.dispose();
            Thankyou rhc=new Thankyou(vmctxt);
            rhc.setVisible(true);
          }  
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        ...
        st="student";
          if(value.equals(pri)){
                ...
                xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+5 where ID=2 ";
                vmctxt=pri;
                ...
                xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+3 where ID=2 ";
                vmctxt=vpri;
          }
                ...
                xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+2 where ID=2";
                vmctxt=tea;
              
          }
          
          else if(value.equals(st)){
              xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+1 where ID=2 ";
              vmctxt=st;
          }  
        ...
        try{
            ...
            Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/evm","root","root");
            Statement stmt=conn.createStatement();
           // String xxx="update vice_manekshaw_captain set NoOfVotes=NoOfVotes+1 where ID=2 ";
            stmt.executeUpdate(xxx);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViceManekshawHouseCaptain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViceManekshawHouseCaptain().setVisible(true);
            }
        });
    }
